...
<body>
    <?php
        require('../controller/TSFController.php');
    ?>
    <section>
        <header class="header">
                            ...
                            <tr>
                                ...
                                <td class="contentBox">
                                    <div class="contentBoxForm">  
                                        ...
                                        <select id="faculty" name="faculty" class="contentBoxSelect">
                                                <option value="null">Select a Faculty</option>
                                                <?php
                                                $i=0;
                                                while($row = $facultyDetails->fetch_assoc()) {
                                                    if($i%2!=1){
                                            ...
                                            <br>
                                            <br>
                                            <label for="facultyInfo" id="facultyInfo" class="contentBoxLabel"></label>
                                            <br>
                                            <br>
                                            <label for="" id="freeTime" class="contentBoxLabel"><?php 
                                                if($freeTime!=""){
                                                    echo "Timing: ".$freeTime;
                                                }
                                            ?>
                                            </label>
                                        </form>
    ...
    <script src="../data/javaScript/TSFJs.js"></script>
</body>
</html>